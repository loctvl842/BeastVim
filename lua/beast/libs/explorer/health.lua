...
function M.check()
	...
	local required_hls = {
		...
		"BeastExplorerGitModified",
		"BeastExplorerGitModifiedStaged",
		"BeastExplorerGitAdded",
		"BeastExplorerGitAddedStaged",
		"BeastExplorerGitRenamed",
		"BeastExplorerGitRenamedStaged",
