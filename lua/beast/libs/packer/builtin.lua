-- Plugins that ship with BeastVim by default. Anything defined here is
-- builtin by virtue of living in this file - packer.setup() merges these
-- specs in and stamps `builtin = true` on each (see init.lua). Badged and
-- delete-blocked in the Packer UI (docs/pm-specs/packer-builtin-plugins.md).
