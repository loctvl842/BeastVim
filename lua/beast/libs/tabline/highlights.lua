...
local inactive_fg = Util.colors.blend(p.text, 0.6, inactive_bg)
local active_border = p.accent3

-- Diagnostic foreground colors
local error_active_fg = p.accent1
local error_inactive_fg = Util.colors.blend(p.accent1, 0.6, inactive_bg)
local warn_active_fg = p.accent2
local warn_inactive_fg = Util.colors.blend(p.accent2, 0.6, inactive_bg)
local info_hint_active_fg = p.accent5
local info_hint_inactive_fg = Util.colors.blend(p.accent5, 0.6, inactive_bg)
...
local error_count_inactive_fg = Util.colors.blend(p.accent1, 0.75 * 0.6, inactive_bg)
local warn_count_active_fg = Util.colors.blend(p.accent2, 0.75, active_bg)
local warn_count_inactive_fg = Util.colors.blend(p.accent2, 0.75 * 0.6, inactive_bg)
local info_hint_count_active_fg = Util.colors.blend(p.accent5, 0.75, active_bg)
local info_hint_count_inactive_fg = Util.colors.blend(p.accent5, 0.75 * 0.6, inactive_bg)
...
Util.colors.set_hl("BeastTl", {
	...
	BufferVisible = { fg = inactive_fg, bg = inactive_bg },
