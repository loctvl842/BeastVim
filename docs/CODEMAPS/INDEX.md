...
- Libraries: 18 (explorer, finder, tabline, notify, toast, key, confirm, packer, buf, statusline, statuscolumn, treesitter, lsp, breadcrumb, indent, scroll, git, window) + shared: view.lua, animate.lua
